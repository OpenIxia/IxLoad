...
try:
    ...
    IxLoadUtils.log('Adding Generate IP Stream command to StatelessPeer1...')
    IxLoadUtils.log('IP in IP encapsulation ...')
    StatelessPeerCommandOptions1 = {'commandType': 'GenerateIPStream', 'remotePeer': 'Traffic2_StatelessPeer2', 'proto':'4','maxPacketFreq': '1000'}
    IxLoadUtils.StatelessPeerUtils.addStatelessPeerCommand(connection, sessionUrl, 'Traffic1@Network1','StatelessPeer1', StatelessPeerCommandOptions1)
    IxLoadUtils.log('Command added to StatelessPeer2 .')

    # Generate UDP Stream command
    IxLoadUtils.log('Adding Generate UDP Stream command to StatelessPeer2...')
    StatelessPeerCommandOptions2 = {'commandType': 'GenerateStream','destination': 'Traffic1_StatelessPeer1','remotePeer': 'Traffic1_StatelessPeer1' }
    IxLoadUtils.StatelessPeerUtils.addStatelessPeerCommand(connection, sessionUrl, 'Traffic2@Network2','StatelessPeer2', StatelessPeerCommandOptions2)
