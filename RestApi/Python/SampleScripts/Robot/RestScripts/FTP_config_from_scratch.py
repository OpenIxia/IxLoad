...
kStatsToDisplayDict =   {
                            ...
                            "FTPClient": ["FTP Simulated Users", "FTP Concurrent Sessions"],
                            "FTPServer": ["FTP Control Bytes Sent", "Data TCP Retries"]
                        }
...
try:
    ...
    IxLoadUtils.log('Adding FTP command to FTP client...')
