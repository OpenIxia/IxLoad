...
kStatsToDisplayDict =   {
                            ...
                            "DNSServer": ["DNS (Type A) Queries Responded Successfully", "DNS Total Bytes Received"]
                        }
...
try:
    ...
    dnsCommandOptions = {'commandType': 'DnsQuery', "dnsServer": "Traffic2_DNSServer1:53"}
