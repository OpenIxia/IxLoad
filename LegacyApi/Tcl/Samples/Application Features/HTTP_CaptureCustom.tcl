...
set logName "simplehttpclientandserver-capturecustom"
...
#-----------------------------------------------------------------------
# 
# Capture the test traffic from the ports
#
#-----------------------------------------------------------------------
...
$clnt_network portList(0).setPortCaptureFileName "c:\\httpclient_custom.cap"
# Client: Turn on automatic capture at the community level
$clnt_t_n_mapping setCommunityCaptureParams $test True

# Custom capture for client
$clnt_t_n_mapping communityCapture.filter.config -filterString "tcp"

# Server: enable the capture on the desired port(s) and specify capture file
$svr_network portList(0).setPortCaptureEnable True
$svr_network portList(0).setPortCaptureFileName "c:\\httpserver_custom.cap"
# Server: Turn on automatic capture at the community level
$svr_t_n_mapping setCommunityCaptureParams $test True

# Custom capture for server
$svr_t_n_mapping communityCapture.filter.config -filterString "tcp"
