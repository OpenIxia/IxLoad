...
$logEngine setLevels $::ixLogger(kLevelDebug) $::ixLogger(kLevelDebug)
...
#$testController setResultDir "C:/temp"
...
# From Windows
::IxLoad retrieveResults {C:\nfs\tmp}

#From Unix
::IxLoad retrieveResults /home/avinash/tmp/
