...
set logName "simplehttpclientandserver-activityIpMapping"
...
set range1 [$clnt_network networkRangeList.getItem 0]
$clnt_t_n_mapping setActivityAvailableForRange $range1 "my_http_client" true
set isAvailable [$clnt_t_n_mapping isActivityAvailableForRange $range1 "my_http_client"]
puts "======= Activity-IP Mapping for Http Agent ========"
puts $isAvailable
puts "==================================================="
