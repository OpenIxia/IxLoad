...
set payloadfile "C:/Program Files/Ixia/IxLoad/Repository/Samples/Video/Sample Videos/Cloud-vs11-withaudio(10Mbps).ts"
puts $payloadfile
...
puts "*********************************************** [$svr_traffic agentList(0).pm.videoProp.stream.indexCount]"
puts "*********************************************** [$svr_traffic agentList(0).pm.videoProp.stream(1).program.indexCount]"
puts "**** [$svr_traffic agentList(0).pm.videoProp.stream(1).program(0).cget -new_pid]"
puts "**** [$svr_traffic agentList(0).pm.videoProp.stream(1).program(0).es_info(1).cget -new_pid]"
...
puts "**** [$svr_traffic agentList(0).pm.videoProp.stream(1).program(0).cget -new_pid]"
puts "**** [$svr_traffic agentList(0).pm.videoProp.stream(1).program(0).es_info(0).cget -new_pid]"
puts "**** [$svr_traffic agentList(0).pm.videoProp.stream(1).program(0).es_info(1).cget -new_pid]"
puts "Debapriyay"
#-----------------------------------------------------------------------
...
puts "Break 3"
$testController setResultDir "[pwd]/RESULTS/simplevideoclientandserver"
puts "Break 4"
