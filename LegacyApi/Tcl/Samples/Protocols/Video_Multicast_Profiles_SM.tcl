...
set logName  "simple_multicast_video_clientserver-profiles"
...
$ip_2 config \
	-count                                   100 \
	-name                                    "ip-2" \
	-gatewayAddress                          "198.19.0.101" \
	-autoMacGeneration                       true \
	-prefix                                  16 \
	-ipAddress                               "198.19.0.1" 

set mac_2 [$ip_2 getLowerRelatedRange "MacRange"]

$mac_2 config \
	-count                                   100 \
	-mac                                     "00:C6:13:00:01:00" \
	-name                                    "mac-2" \
	-incrementBy                             "00:00:00:00:01:00" 
...
$clnt_traffic agentList(0).pm.signalling.config \
    -enable_custom                  "1"

# needed to remove the default entries inserted into the table
# omit this line to actually use the default entries, if you desire
$clnt_traffic agentList(0).pm.signalling.profile_table.clear

$clnt_traffic agentList(0).pm.signalling.profile_table.appendItem \
    -name                        "slowSwitching" \
    -percentage                   "50.0" \
    -duration_min                "60" \
    -duration_max                "60" \
    -channel_switch_delay_min    "5000" \
    -channel_switch_delay_max    "5000" 
...
$testController setResultDir "[pwd]/RESULTS/simple_multicast_video_clientserver-profiles_test"
