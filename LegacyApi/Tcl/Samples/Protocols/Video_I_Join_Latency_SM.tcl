...
$clnt_traffic agentList(0).pm.stats.config \
    -enableFrameStats              "1"
...
$testController setResultDir "[pwd]/RESULTS/simplevideoclientandserver1"
...
${NS}::AddVideoPerStreamStats \
    ...
    -statList {{"Packets" "kSum"} {"Bytes" "kSum"} {"Stream Name" "kString"} {"I Frames Rcvd" "kSum"} {"I Join Latency (ms)" "kSum"}} \
