...
$clnt_traffic agentList(0).pm.options.config \
    ...
    -traceFileName          "C:/Program Files/Ixia/IxLoad/Client/TclApi/Samples/2.1.10_src_trace_http.cap" \
    -enableFilter               0
...
$testController setResultDir "[pwd]/RESULTS/simple_tracefilereplay"
