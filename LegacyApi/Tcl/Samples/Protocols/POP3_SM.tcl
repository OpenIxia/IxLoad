...
set logName "simplepop3clientandserver"
...
$clnt_traffic agentList(0).commandList.appendItem \
    -command    $::Pop3Command(kReceive) \
    -arguments  "198.18.200.1:110" 
...
$svr_traffic agentList(0).mailMessageList.appendItem \
...
$svr_traffic agentList(0).mailMessageList(0).headerList(0).config \
    -data "From:fromName@company.com"
$svr_traffic agentList(0).mailMessageList(0).headerList(1).config \
    -data "To:toName@company.com"
$svr_traffic agentList(0).mailMessageList(0).headerList(2).config \
    -data [format "%s:%s" $::MailHeader(kSubjectName) $::MailHeader(kSubjectDefault)]

$svr_traffic agentList(0).mailMessageList(0).attachmentList.appendItem \
...
$svr_traffic agentList(0).mailBox.appendItem \
    -mailMessage    [$svr_traffic agentList(0).mailMessageList.getItem 0] \
    -count          10
...
$testController setResultDir "[pwd]/RESULTS/simplepop3clientandserver"
