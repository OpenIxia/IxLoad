...
foreach {pageObject destination} {
    ...
    $clnt_traffic agentList(1).actionList.appendItem  \
        -command        "GET" \
        -destination    $destination \
        -pageObject     $pageObject
}
...
#
$clnt_t_n_mapping setObjectiveTypeForActivity "HTTPClient1" $::ixObjective(kObjectiveTypeSimulatedUsers)
$clnt_t_n_mapping setObjectiveValueForActivity "HTTPClient1" 100
$clnt_t_n_mapping setPortMapForActivity "HTTPClient1" $::ixPortMap(kPortMapFullMesh)

$clnt_t_n_mapping setObjectiveTypeForActivity "HTTPClient2" $::ixObjective(kObjectiveTypeSimulatedUsers)
$clnt_t_n_mapping setObjectiveValueForActivity "HTTPClient2" 100
$clnt_t_n_mapping setPortMapForActivity "HTTPClient2" $::ixPortMap(kPortMapFullMesh)
...
$testController setResultDir "[pwd]/RESULTS/HTTP_statFilter"
...
${NS}::AddStat \
    ...
    -statName        "HTTP Simulated Users" \
    -aggregationType "kSum" \
    -filterList      {Activity {"client_traffic@clnt_network - HTTPClient1"}}
...
${NS}::AddStat \
    ...
    -statName        "HTTP Simulated Users" \
    -aggregationType "kSum" \
    -filterList      {Activity {"client_traffic@clnt_network - HTTPClient2"}}
