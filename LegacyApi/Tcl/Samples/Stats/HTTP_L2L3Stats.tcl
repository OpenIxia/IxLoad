...
${NS}::AddL2L3Stat \
    -caption "Watch_Stat_L2L3_1" \
    -statSourceType "PortMonitor" \
    -statName "Link State" \
    -aggregationType kNone \
    -filterList {}

${NS}::AddL2L3Stat \
    -caption "Watch_Stat_L2L3_2" \
    -statSourceType "PortMonitor" \
    -statName "Line Speed" \
    -aggregationType kNone \
    -filterList {}
...
${NS}::AddL2L3Stat \
    -caption "Watch_Stat_L2L3_3" \
    -statSourceType "PortMonitor" \
    -statName "Frames Sent" \
    -aggregationType kNone \
    -filterList {}

${NS}::AddL2L3Stat \
    -caption "Watch_Stat_L2L3_4" \
    -statSourceType "PortMonitor" \
    -statName "Frames Sent Rate" \
    -aggregationType kNone \
    -filterList {}

${NS}::AddL2L3Stat \
    -caption "Watch_Stat_L2L3_5" \
    -statSourceType "PortMonitor" \
    -statName "Valid Frames Received" \
    -aggregationType kNone \
    -filterList {}

${NS}::AddL2L3Stat \
    -caption "Watch_Stat_L2L3_6" \
    -statSourceType "PortMonitor" \
    -statName "Valid Frames Received Rate" \
    -aggregationType kNone \
    -filterList {}

${NS}::AddL2L3Stat \
    -caption "Watch_Stat_L2L3_7" \
    -statSourceType "PortMonitor" \
    -statName "Bytes Sent" \
    -aggregationType kNone \
    -filterList {}
...
${NS}::AddL2L3Stat \
    -caption "Watch_Stat_L2L3_8" \
    -statSourceType "PortMonitor" \
    -statName "Bytes Sent Rate" \
    -aggregationType kNone \
    -filterList {}


${NS}::AddL2L3Stat \
    -caption "Watch_Stat_L2L3_9" \
    -statSourceType "PortMonitor" \
    -statName "Bytes Received" \
    -aggregationType kNone \
    -filterList {}

${NS}::AddL2L3Stat \
    -caption "Watch_Stat_L2L3_10" \
    -statSourceType "PortMonitor" \
    -statName "Bytes Received Rate" \
    -aggregationType kNone \
    -filterList {}

${NS}::AddL2L3Stat \
    -caption "Watch_Stat_L2L3_11" \
    -statSourceType "PortMonitor" \
    -statName "Transmit Arp Request" \
    -aggregationType kNone \
    -filterList {}

${NS}::AddL2L3Stat \
    -caption "Watch_Stat_L2L3_12" \
    -statSourceType "PortMonitor" \
    -statName "Transmit Arp Reply" \
    -aggregationType kNone \
    -filterList {}

${NS}::AddL2L3Stat \
    -caption "Watch_Stat_L2L3_13" \
    -statSourceType "PortMonitor" \
    -statName "Receive Arp Request" \
    -aggregationType kNone \
    -filterList {}

${NS}::AddL2L3Stat \
    -caption "Watch_Stat_L2L3_14" \
    -statSourceType "PortMonitor" \
    -statName "Receive Arp Reply" \
    -aggregationType kNone \
    -filterList {}
