...
set logName  "simplevideoclientandserver-perStreamStats"
...
$clnt_traffic agentList(0).pm.commands.appendItem \
    -id                            "PlayCommand"  \
    -destination_server_activity   "clnt_traffic_my_video_client:554" \
...
$testController setResultDir "[pwd]/RESULTS/simplevideoclientandserver-perStreamStats"
