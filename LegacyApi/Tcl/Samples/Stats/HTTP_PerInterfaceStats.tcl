...
set logName "HTTP_PerInterfaceStats"
...
#
# To query per interface stats, you need to make sure 
# 1. enableStats is set to 1 in ranges where ips you query belong to 
# 2. AddPerInterfaceStat can be called only once for each configured statSourceType 
#
${NS}::AddPerInterfaceStats \
    -test $test \
    -statSourceType "Interface IPv4 - Client" \
    -statList {{"Packets Sent" "kSum"} {"Packets Received" "kSum"}} \
    -ipList {"198.18.2.1" "198.18.2.2"}
