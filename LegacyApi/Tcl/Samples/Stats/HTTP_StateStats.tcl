...
$clnt_traffic agentList.appendItem \
    -name                   "my_http_client_2" \
    -protocol               "HTTP" \
    -type                   "Client" \
    -maxSessions            3 \
    -httpVersion            $::HTTP_Client(kHttpVersion11) \
    -keepAlive              0 \
    -maxPersistentRequests  3 \
    -followHttpRedirects    0 \
    -enableCookieSupport    0 \
...
${NS}::AddStat \
    ...
    -filterList {{Activity} {"client_traffic@clnt_network - my_http_client"}}
#    -filterList {}
