...
set logName "simplehttpclientandserver-perUrlPerIpStats"
...
foreach {pageObject destination} {
    "/4k.html" "svr_traffic_my_http_server"
    "/8k.html" "svr_traffic_my_http_server"
} {
...
$testController setResultDir "[pwd]/RESULTS/simplehttpclientandserver-perInterfaceStats"
...
${NS}::AddPerUrlPerIpStats \
    -test $test \
    -statSourceType "HTTP Server Per URL Per IPv4" \
    -statList {{"HTTP Requests Received" "kSum"} {"HTTP Requests Successful" "kSum"} {"HTTP Requests Failed" "kSum"}} \
    -urlList {"4k.html"} \
    -ipList {"198.18.200.1"}
