...
# ixNet objects needs to be added in the list before they are configured!
$IP_1 extensionList.appendItem -object $Impair_1
...
set impair_1 [$ip_1 getExtensionRange $Impair_1]
...
# ixNet objects needs to be added in the list before they are configured!
$IP_2 extensionList.appendItem -object $Impair_2
...
set impair_2 [$ip_2 getExtensionRange $Impair_2]

set svr_network_CustomProfile1 [::IxLoad new ixNetImpairProfile]
$svr_network_CustomProfile1 config \
	-jitter                                  5 \
	-delay                                   10 \
	-reorderLength                           10 \
	-reorder                                 2 \
	-gap                                     100 \
	-bandwidthUnitsIn                        "kbit" \
	-name                                    "svr_network-CustomProfile1" \
	-bandwidthUnits                          "kbit" 

$impair_2 config \
	-enabled                                 true \
	-name                                    "impair-2" \
	-profile                                 $svr_network_CustomProfile1 
...
$testController setResultDir "[pwd]/RESULTS/simplehttpclientandserver-vlanImpairment"
