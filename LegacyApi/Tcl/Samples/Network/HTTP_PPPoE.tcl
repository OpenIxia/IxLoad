...
$clnt_network networkRangeList.appendItem \
    ...
    -rangeType      $::ixIP(kPPPoE)

$clnt_network networkRangeList(0).pppoeParameters.config \
    -setupRate                  100 \
    -enableThrottling           True \
    -maxOutstandingSessions     1000 \
    -serverResponseTimeout      60 \
    -padiTimeout                10 \
    -padrTimeout                10 \
    -padiRetries                5 \
    -padrRetries                5 \
    -acSelection                $::ixPppoe(kMatchFirst) \
    ...
    -redialMax                  20 \
    -mtu                        1492 \
    -enableEchoReply            True \
    -enableEchoRequest          False \
    -echoRequestInterval        60 \
    -lcpTimeout                 15 \
    -lcpRetries                 5 \
    -authType                   $::ixPppoe(kAuthTypeNone) \
    -authTimeout                15 \
    -authRetries                5 \
    -papUser                    "user" \
...
$svr_network networkRangeList(0).pppoeParameters.config \
    -setupRate                  100 \
    -enableThrottling           True \
    -maxOutstandingSessions     1000 \
    -serverResponseTimeout      60 \
...
$testController setResultDir "RESULTS/simplehttpclientandserver-pppoe"
