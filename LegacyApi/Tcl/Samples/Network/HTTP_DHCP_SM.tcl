...
set logName "simplehttpclientandserver-dhcp"
...
$testController setResultDir "[pwd]/RESULTS/simplehttpclientandserver-dhcp"
...
${NS}::AddNetworkStat \
    -caption "Network_Stat_1" \
    -statSourceType "DHCPv4" \
    -statName "Sessions Initiated" \
    -aggregationType $aggregation_type \
    -filterList {}
#
