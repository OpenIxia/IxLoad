...
$clnt_network networkRangeList(0).dhcpParameters.config \
...
$svr_network networkRangeList(0).dhcpParameters.config \
    -firstServerReply       True \
    -serverIp               "10.0.0.1" \
    -timeout                60 \
    -maxOutstandingRequests 1000 \
...
$testController setResultDir "RESULTS/simplehttpclientandserver-dhcp"
