...
set ipsec_1 [::IxLoad new ixNetIPSecRange]
# ixNet objects needs to be added in the list before they are configured!
$IPSec_1 rangeList.appendItem -object $ipsec_1
...
set ip_1 [$ipsec_1 getLowerRelatedRange "IpV4V6Range"]
...
set IPSec_2 [::IxLoad new ixNetIPSecPlugin]
# ixNet objects needs to be added in the list before they are configured!
$IP_2 childrenList.appendItem -object $IPSec_2

$IPSec_2 config \
	-name                                    "IPSec-2" 

$IPSec_2 childrenList.clear

$IPSec_2 extensionList.clear
...
# Setting the ranges starting with the plugin on top of the stack
#################################################
$IPSec_2 rangeList.clear

set ipsec_2 [::IxLoad new ixNetIPSecRange]
# ixNet objects needs to be added in the list before they are configured!
$IPSec_2 rangeList.appendItem -object $ipsec_2
...
set ip_2 [$ipsec_2 getLowerRelatedRange "IpV4V6Range"]
...
$testController setResultDir "[pwd]/RESULTS/simplehttpclientandserver-ipsec"
