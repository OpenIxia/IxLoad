...
set logName "simplehttpclientandserver-pppoe"
...
# ixNet objects needs to be added in the list before they are configured!
$MAC_VLAN_1 childrenList.appendItem -object $PPPoX_1
...
set pppox_1 [::IxLoad new ixNetPppoxRange]
# ixNet objects needs to be added in the list before they are configured!
$PPPoX_1 rangeList.appendItem -object $pppox_1
...
$pppox_1 config \
	...
	-enableRedial                            false \
	-lcpRetries                              5 \
	-papPassword                             "passowrd" \
	-name                                    "pppox-1" \
	-serviceOptions                          "serviceName" 

$pppox_1 domainGroupList.clear

$pppox_1 acMacTable.clear

set mac_1 [$pppox_1 getLowerRelatedRange "MacRange"]
...
set vlan_1 [$pppox_1 getLowerRelatedRange "VlanIdRange"]
...
set PPPoX_2 [::IxLoad new ixNetPppoxPlugin]
# ixNet objects needs to be added in the list before they are configured!
$MAC_VLAN_2 childrenList.appendItem -object $PPPoX_2

$PPPoX_2 config \
	-name                                    "PPPoX-2" 

$PPPoX_2 childrenList.clear

$PPPoX_2 extensionList.clear
...
# Setting the ranges starting with the plugin on top of the stack
#################################################
$PPPoX_2 rangeList.clear

set pppox_2 [::IxLoad new ixNetPppoxRange]
# ixNet objects needs to be added in the list before they are configured!
$PPPoX_2 rangeList.appendItem -object $pppox_2
...
$pppox_2 domainGroupList.clear

$pppox_2 acMacTable.clear

set mac_2 [$pppox_2 getLowerRelatedRange "MacRange"]

$mac_2 config \
	-count                                   20 \
	-mac                                     "00:C7:12:02:01:00" \
	-name                                    "mac-2" 

set vlan_2 [$pppox_2 getLowerRelatedRange "VlanIdRange"]
...
$testController setResultDir "[pwd]/RESULTS/simplehttpclientandserver-pppoe"
