...
set clientCard "1.$::IxLoadPrivate::SimpleSettings::clientPort(CARD_ID)"
set serverCard "1.$::IxLoadPrivate::SimpleSettings::serverPort(CARD_ID)"
$chassisChain setCardAggregation [list $clientCard $serverCard] $::ixCard(k1GAggregated)
